...
from btc_analysis.market_data import add_crypto, mkt_data_op, yesterday_str
from btc_analysis.mongo_func import mongo_coll_drop, mongo_indexing, query_mongo
...
complete_df = add_crypto(price_df)
print(complete_df)
